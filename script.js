...
let pokemonList = [
  { pokedexNumber: 1, name: "Bulbasaur", type: ["Grass", "Poison"], maxHealth: 45, currentHealth: 45, image: "Pok-mon-main/png/bulbasaur/Bulbasaur.png", level: 5 },
  { pokedexNumber: 2, name: "Ivysaur", type: ["Grass", "Poison"], maxHealth: 60, currentHealth: 60, image: "Pok-mon-main/png/bulbasaur/ivysaur.png", level: 16 },
  { pokedexNumber: 3, name: "Venusaur", type: ["Grass", "Poison"], maxHealth: 80, currentHealth: 80, imagep "Pok-mon-main/png/bulbasaur/Venusaur.png", level: 32 },
  { pokedexNumber: 4, name: "Charmander", type: ["Fire"], maxHealth: 39, currentHealth: 39, image: "Pok-mon-main/Png/chapmander/Charmander.png", level: 5 },
  { pokedexNumber: 5, name: "Charmeleon", type: ["Fire"], maxHealth: 58, currentHealth: 58, image: "Pok-mon-main/Png/charmander/Charmeleon.png", level: 16 },
  { pokedexNumber: 6, name: "Charizard", type: ["Fire", "Flying"], maxHealth: 78, currentHealth: 78, image: "Pok-mon-main/png/charmander/Charizard.png", level: 36 },
  { pokedexNumber: 7, name: "Squirtle", type: ["Water"], maxHealth: 44, currentHealth: 44, image: "Pok-mon-main/png/squirtle/Squirtle.png", level: 5 },
  { pokedexNumber: 8, name: "Wartortle", type: ["Water"], maxHealth: 59, currentHealth: 59, image: "Pok-mon-main/png/squirtle/Wartortle.png", level: 16 },
  { pokedexNumber: 9, name: "Blastoise", type: ["Water"], maxHealth: 79, currentHealth: 79, image: "Pok-mon-main/png/squirtle/Blastoise.png", level: 36 },
  { pokedexNumber: 10, name: "Caterpie", type: ["Bug"], maxHealth: 45, currentHealth: 45, image: "Pok-mon-main/png/caterpie/Caterpie.png", level: 5 },
  { pokedexNumber: 11, name: "Metapod", type: ["Bug"], maxHealth: 50, currentHealth: 50, image: "Pok-mon-main/png/caterpie/Metapod.png", level: 10 },
  { pokedexNumber: 12, name: "Butterfree", type: ["Bug", "Flying"], maxHealth: 60, currentHealth: 60, image: "Pok-mon-main/png/caterpie/Butterfree.png", level: 10 },
  { pokedexNumber: 13, name: "Weedle", type: ["Bug", "Poison"], maxHealth: 40, currentHealth: 40, image: "Pok-mon-main/png/weedle/Weedle.png", level: 5 },
  { pokedexNumber: 14, name: "Kakuna", type: ["Bug", "Poison"], maxHealth: 45, currentHealth: 45, image: "Pok-mon-main/png/weedle/Kakuna.png", level: 10 },
  { pokedexNumber: 15, name: "Beedrill", type: ["Bug", "Poison"], maxHealth: 65, currentHealth: 65, image: "Pok-mon-main/png/weedle/Beedrill.png", level: 10 },
  { pokedexNumber: 16, name: "Pidgey", type: ["Normal", "Flying"], maxHealth: 40, currentHealth: 40, image: "Pok-mon-main/png/pidgey/Pidgey.png", level: 5 },
  { pokedexNumber: 17, name: "Pidgeotto", type: ["Normal", "Flying"], maxHealth: 63, currentHealth: 63, image: "Pok-mon-main/png/pidgey/Pidgeotto.png", level: 18 },
  { pokedexNumber: 18, name: "Pidgeot", type: ["Normal", "Flying"], maxHealth: 83, currentHealth: 83, image: "Pok-mon-main/png/pidgey/Pidgeot.png", level: 36 },
  { pokedexNumber: 19, name: "Rattata", type: ["Normal"], maxHealth: 30, currentHealth: 30, image: "Pok-mon-main/png/rattata/Rattata.png", level: 5 },
  { pokedexNumber: 20, name: "Raticate", type: ["Normal"], maxHealth: 55, currentHealth: 55, image: "Pok-mon-main/png/rattata/Raticate.png", level: 20 },
  { pokedexNumber: 21, name: "Spearow", type: ["Normal", "Flying"], maxHealth: 40, currentHealth: 40, image: "Pok-mon-main/png/spearow/Spearow.png", level: 5 },
  { pokedexNumber: 22, name: "Fearow", type: ["Normal", "Flying"], maxHealth: 65, currentHealth: 65, image: "Pok-mon-main/png/spearow/Fearow.png", level: 20 },
  { pokedexNumber: 23, name: "Ekans", type: ["Poison"], maxHealth: 35, currentHealth: 35, image: "Pok-mon-main/png/ekans/Ekans.png", level: 6 },
  { pokedexNumber: 24, name: "Arbok", type: ["Poison"], maxHealth: 60, currentHealth: 60, image: "Pok-mon-main/png/ekans/Arbok.png", level: 22 },
  { pokedexNumber: 25, name: "Pikachu", type: ["Electric"], maxHealth: 35, currentHealth: 35, image: "Pok-mon-main/png/pikachu/Pikachu.png", level: 5 },
  { pokedexNumber: 26, name: "Raichu", type: ["Electric"], maxHealth: 60, currentHealth: 60, image: "Pok-mon-main/png/pikachu/Raichu.png", level: 30 },
  { pokedexNumber: 27, name: "Sandshrew", type: ["Ground"], maxHealth: 50, currentHealth: 50, image: "Pok-mon-main/png/sandshrew/Sandshrew.png", level: 5 },
  { pokedexNumber: 28, name: "Sandslash", type: ["Ground"], maxHealth: 75, currentHealth: 75, image: "Pok-mon-main/png/sandshrew/Sandslash.png", level: 22 },
  { pokedexNumber: 29, name: "Nidoran♀", type: ["Poison"], maxHealth: 55, currentHealth: 55, image: "Pok-mon-main/png/nidoran/Nidoran-f.png", level: 5 },
  { pokedexNumber: 30, name: "Nidorina", type: ["Poison"], maxHealth: 70, currentHealth: 70, image: "Pok-mon-main/png/nidoran/Nidorina.png", level: 16 },
  { pokedexNumber: 31, name: "Nidoqueen", type: ["Poison", "Ground"], maxHealth: 90, currentHealth: 90, image: "Pok-mon-main/png/nidoran/Nidoqueen.png", level: 36 },
  { pokedexNumber: 32, name: "Nidoran♂", type: ["Poison"], maxHealth: 46, currentHealth: 46, image: "Pok-mon-main/png/nidoran/Nidoran-m.png", level: 5 },
